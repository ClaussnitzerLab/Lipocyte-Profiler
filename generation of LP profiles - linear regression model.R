...
colnames(effect_df_1)<-c("score.eta_sq","BMI.eta_sq", "age.eta_sq", "sex.eta_sq", "batch.eta_sq" )

###merge dataframes####
features<-colvector
pvalue_data<-cbind(pvalue_df_1, q.l, pvalue_df.a_1, q.a,coef, features, effect_df_1 )
####save output####
